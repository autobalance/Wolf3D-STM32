...
const pixcolor redshifts[NUMREDSHIFTS][256]={
#ifdef SPEAR
    #include "sodredpal.inc"
#else
    #include "wolfredpal.inc"
#endif
};
const pixcolor whiteshifts[NUMWHITESHIFTS][256]={
#ifdef SPEAR
    #include "sodwhitepal.inc"
#else
    #include "wolfwhitepal.inc"
#endif
};
